...
//! encodings (WHATWG Encoding Standard), detecção de BOM, indexação de linhas (`LineIndex`), concatenação zero-copy (`StringBuilder`) e normalização de espaços em branco HTML.
