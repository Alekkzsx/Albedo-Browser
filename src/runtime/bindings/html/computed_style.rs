...
impl ComputedCSSStyleDeclaration {
    ...
    pub fn get_property_value(&self, property: String) -> String {
        ...
        let root_style = stylesheet_lock.calculate_style(&dom_lock, 0, None, None, None, None, None, 1024.0, 768.0, "light");
        let style = stylesheet_lock.calculate_style(&dom_lock, self.node_idx, None, Some(&root_style), None, None, None, 1024.0, 768.0, "light");
