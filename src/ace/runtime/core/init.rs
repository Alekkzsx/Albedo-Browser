...
pub fn init_stdlib(rt: &JsRuntime, url: &str) -> JsResult<()> {
    ...
    crate::ace::runtime::bindings::webapi::notification::register(&rt.context.lock().unwrap())?;
    crate::ace::runtime::bindings::webapi::geolocation::register(&rt.context.lock().unwrap())?;
    crate::ace::runtime::bindings::webapi::url::register(rt)?;
    crate::ace::runtime::bindings::webapi::history::register(rt)?;
    crate::ace::runtime::bindings::webapi::navigator::register(&rt.context.lock().unwrap())?;
