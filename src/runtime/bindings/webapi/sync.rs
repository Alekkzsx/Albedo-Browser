...
pub struct SyncManager {
    ...
    #[qjs(skip_trace)]
    pub background_sync_queue: Arc<crate::runtime::core::service_worker::BackgroundSyncQueue>,
}
...
pub struct PeriodicSyncManager {
    ...
    pub registration_id: String,
    #[qjs(skip_trace)]
    pub periodic_sync_scheduler: Arc<crate::runtime::core::service_worker::PeriodicSyncScheduler>,
}
