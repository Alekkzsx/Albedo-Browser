...
impl EventLoop {
    ...
    pub fn set_background_sync_queue(
        &mut self,
        queue: std::sync::Arc<crate::runtime::core::service_worker::BackgroundSyncQueue>,
    ) {
    ...
    pub fn set_periodic_sync_scheduler(
        &mut self,
        scheduler: std::sync::Arc<crate::runtime::core::service_worker::PeriodicSyncScheduler>,
    ) {
    ...
    pub fn take_pending_background_sync(
        &self,
    ) -> Vec<crate::runtime::core::service_worker::SyncTask> {
    ...
    pub fn take_pending_periodic_sync(
        &self,
    ) -> Vec<crate::runtime::core::service_worker::PeriodicSyncTask> {
