//! Chrome HTML Parser Comparison Tests
//! 
//! These tests compare ACE HTML parser performance against Chrome's parser
//! using the benchmark infrastructure in chrome_bench.rs
...
"#, i, i));
    ...
    #[test]
    fn test_chrome_comparison_small() {
        let runner = ChromeBenchRunner::new();
        
        if !runner.is_available() {
            println!("⚠️  Skipping Chrome comparison: Node.js not available");
            println!("   Install Node.js to enable Chrome benchmarks");
            return;
        }
    ...
    #[test]
    fn test_chrome_comparison_medium() {
        let runner = ChromeBenchRunner::new();
    ...
    #[test]
    fn test_chrome_comparison_wikipedia() {
        let runner = ChromeBenchRunner::new();
    ...
    fn test_generate_full_comparison_report() {
        ...
        println!("\n🔬 Running full Chrome comparison suite...\n");
        ...
        // Save report
        std::fs::write("target/chrome_comparison_report.md", &report)
            .expect("Failed to write report");
        
        println!("\n📊 Comparison report saved to: target/chrome_comparison_report.md\n");
        println!("{}", report);
    ...
    fn test_benchmark_runner_availability() {
        ...
        println!("Chrome benchmark runner available: {}", is_available);
        
        if is_available {
            println!("✓ Node.js is installed");
            println!("✓ Benchmark script exists");
        } else {
            println!("⚠️  Chrome benchmarks not available");
            println!("   Install Node.js to enable Chrome comparison");
        }
    }
    ...
    fn test_chrome_comparison_stress() {
        let runner = ChromeBenchRunner::new();
