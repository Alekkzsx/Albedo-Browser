    ...
    pub fn new(ctx: Ctx<'_>, url: String) -> Result<Self> {
        ...
        *rt.origin.lock().unwrap() = parent_rt.origin.lock().unwrap().clone();
        ...
        rt.with_context(move |ctx: &rquickjs::Context| {
            ctx.with(|ctx: Ctx<'_>| {
                let _ = crate::ace::runtime::bindings::utils::console::Console::register(&rt_clone);
                let _ = crate::ace::runtime::bindings::webapi::timers::register(&rt_clone);
                let _ = crate::ace::runtime::core::init::register_events(&rt_clone);
        ...
        thread::spawn(move || {
            ...
            // Cleanup
            crate::ace::runtime::core::registry::unregister_runtime(worker_rt_id);
        });
