...
pub struct JsRuntime {
    ...
    #[qjs(skip_trace)]
    pub idb_worker:
        Arc<Mutex<crate::runtime::bindings::webapi::idb_service::worker::IDBServiceWorker>>,
    #[qjs(skip_trace)]
...
impl JsRuntime {
    ...
    pub fn new_with_jit(
        ...
        let idb_worker =
            crate::runtime::bindings::webapi::idb_service::worker::IDBServiceWorker::new(
        ...
        let interceptor = Arc::new(
            crate::runtime::bridge::quickjs_intercept::QuickJsInterceptor::new(
        ...
        let rt = Self {
            ...
            module_registry: Arc::new(Mutex::new(
                crate::runtime::core::module_loader::ModuleRegistry::new(""),
            )),
