        ...
        std::thread::spawn(move || {
            ...
            let _ = rt.with_context(|ctx| {
                ctx.with(|ctx| {
                    ...
                    // Basic APIs
                    let _ = crate::runtime::bindings::webapi::console::Console::register_in_ctx(&ctx);
                    let _ = crate::runtime::bindings::webapi::timers::register_in_rt(&rt, &ctx);
                    let _ = crate::runtime::bindings::webapi::fetch::register_in_rt(&rt, &ctx);
                });
            });
