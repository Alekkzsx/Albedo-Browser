...
mod tests {
    ...
    fn jit_run_1(qjs_func: QjsBytecodeFunction, arg: JsValue) -> JsValue {
        ...
        let id = compiler.compile(&air_func).expect("Falha na compilação JIT");
    ...
    fn test_nested_arithmetic() {
        ...
        // (5+3)*(5-3) = 8*2 = 16
        assert_eq!(jit_run_2(qjs.clone(), JsValue::int32(5), JsValue::int32(3)).as_int32(), 16);
        // (10+10)*(10-10) = 20*0 = 0
        assert_eq!(jit_run_2(qjs.clone(), JsValue::int32(10), JsValue::int32(10)).as_int32(), 0);
    }
