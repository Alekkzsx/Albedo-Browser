...
// Reexports da subpasta graphics/
...
// Reexports da subpasta layout/
pub use layout::{ElementGeometry, GridContext, ACEPrimitive, InvalidationManager};
    ...
    fn build_layout_tree(
        ...
        if style.display == crate::engine::style::css_values::CssDisplay::Grid {
            ...
            let transformed_text =
                crate::engine::layout::inline::apply_text_transform(text.as_ref(), &style.text_transform);
                ...
                if let Some(geom) = geometry.get(&node_idx) {
                    ...
                    let mut text = match &node.node_type {
                        crate::engine::dom::AceNodeType::Text(t) => {
                            crate::engine::layout::inline::apply_text_transform(
                                t.as_ref(),
...
use layout_types::{DisplayItem, FloatContext, FloatRect};
